...
<!-- basic styles -->
<link href="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/css/bootstrap.min.css" rel="stylesheet" />
<link href="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/css/bootstrap-responsive.min.css" rel="stylesheet" />
<link rel="stylesheet" href="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/css/font-awesome.min.css" />
<!--[if IE 7]>
		  <link rel="stylesheet" href="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/css/font-awesome-ie7.min.css" />
		<![endif]-->
<!-- page specific plugin styles -->

<!-- ace styles -->
<link rel="stylesheet" href="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/css/ace.min.css" />
<link rel="stylesheet" href="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/css/ace-responsive.min.css" />
<link rel="stylesheet" href="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/css/ace-skins.min.css" />
<!--[if lt IE 9]>
		  <link rel="stylesheet" href="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/css/ace-ie.min.css" />
		<![endif]-->
				...
				<div class="row-fluid">
					...
					<div class="alert alert-block alert-success">
						...
						<i class="icon-ok green"></i> Welcome to <strong class="green">Ace
							<small>(v1)</small>
						</strong>, the lightweight, feature-rich, easy to use and well-documented
						admin template.
					</div>
					...
					<div class="row-fluid">
						<div class="span7 infobox-container">
							...
							<div class="infobox infobox-small infobox-dark infobox-grey">
								...
								<div class="infobox-data">
									<span class="infobox-content"><b>Downloads</b></span> <br /> <span
										class="infobox-content">1,205</span>
								</div>
							</div>
						</div>
										...
										<div class="tab-content padding-8">
											<div id="task-tab" class="tab-pane active">
												...
												<ul id="tasks" class="item-list">
													<li class="item-orange clearfix"><label class="inline"><input
															type="checkbox" /><span class="lbl"> Answering
																customer questions</span></label>
														<div class="pull-right easy-pie-chart percentage"
															data-size="30" data-color="#ECCB71" data-percent="42">
															<span class="percent">42</span>%
														</div></li>
													<li class="item-red clearfix"><label class="inline"><input
															type="checkbox" /><span class="lbl"> Fixing bugs</span></label>
													...
													<li class="item-default clearfix"><label
														class="inline"><input type="checkbox" /><span
															class="lbl"> Adding new features</span></label>
														<div class="inline pull-right position-relative">
															...
															<ul
																class="dropdown-menu dropdown-icon-only dropdown-yellow pull-right dropdown-caret dropdown-closer">
																<li><a href="#" class="tooltip-success"
																	data-rel="tooltip" title="Mark&nbsp;as&nbsp;done"
																	data-placement="left"><span class="green"><i
																			class="icon-ok"></i></span></a></li>
																<li><a href="#" class="tooltip-error"
																	data-rel="tooltip" title="Delete" data-placement="left"><span
																		class="red"><i class="icon-trash"></i></span></a></li>
															</ul>
														</div></li>
													<li class="item-blue"><label class="inline"><input
															type="checkbox" /><span class="lbl"> Upgrading
																scripts used in template</span></label></li>
													<li class="item-grey"><label class="inline"><input
															type="checkbox" /><span class="lbl"> Adding new
																skins</span></label></li>
													<li class="item-green"><label class="inline"><input
															type="checkbox" /><span class="lbl"> Updating
																server software up</span></label></li>
													<li class="item-pink"><label class="inline"><input
															type="checkbox" /><span class="lbl"> Cleaning up</span></label>
													</li>
												</ul>
											</div>
											...
											<div id="member-tab" class="tab-pane">
												<div class="clearfix">
															...
															<div>
																...
																<div class="inline position-relative">
																	...
																	<ul
																		...
																		<li><a href="#" class="tooltip-warning"
																			data-rel="tooltip" title="Reject"
																			data-placement="left"><span class="orange"><i
																					class="icon-remove"></i></span> </a></li>
																		<li><a href="#" class="tooltip-error"
																			data-rel="tooltip" title="Delete"
													...
													<div class="itemdiv memberdiv">
														...
														<div class="body">
															...
															<div
																class="label label-info arrowed-in  arrowed-in-right">online</div>
														</div>
													</div>
												...
												<div class="center">
													<i class="icon-group icon-2x green"></i> &nbsp; <a href="#">See
														all members &nbsp; <i class="icon-arrow-right"></i>
													</a>
												</div>
													...
													<div class="itemdiv commentdiv">
														...
														<div class="tools">
															<a href="#" class="btn btn-minier btn-info"><i
																class="icon-only icon-pencil"></i></a> <a href="#"
																class="btn btn-minier btn-danger"><i
																class="icon-only icon-trash"></i></a>
														</div>
													</div>
									...
									<div class="widget-main no-padding">
										...
										<div class="dialogs">
											...
											<div class="itemdiv dialogdiv">
												...
												<div class="body">
													<div class="time">
														<i class="icon-time"></i> <span class="muted">3 min</span>
													</div>
													<div class="name">
														<a href="#">Jim</a>
													</div>
...
<!-- basic scripts -->
<script src="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/1.9.1/jquery.min.js"></script>
<script type="text/javascript">
	window.jQuery || document.write("<script src='<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/js/jquery-1.9.1.min.js'>\x3C/script>");
</script>
<script src="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/js/bootstrap.min.js"></script>
<!-- page specific plugin scripts -->
<!--[if lt IE 9]>
	<script type="text/javascript" src="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/js/excanvas.min.js"></script>
<![endif]-->
<script type="text/javascript" src="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/js/jquery-ui-1.10.2.custom.min.js"></script>
<script type="text/javascript" src="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/js/jquery.ui.touch-punch.min.js"></script>
<script type="text/javascript" src="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/js/jquery.slimscroll.min.js"></script>
<script type="text/javascript" src="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/js/jquery.easy-pie-chart.min.js"></script>
<script type="text/javascript" src="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/js/jquery.sparkline.min.js"></script>
<script type="text/javascript" src="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/js/jquery.flot.min.js"></script>
<script type="text/javascript" src="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/js/jquery.flot.pie.min.js"></script>
<script type="text/javascript" src="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/js/jquery.flot.resize.min.js"></script>
<!-- ace scripts -->
<script src="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/js/ace-elements.min.js"></script>
<script src="<c:out value="${pageContext.servletContext.contextPath }"/>/admin/<c:out value = "${appContext }"/>/js/ace.min.js"></script>
